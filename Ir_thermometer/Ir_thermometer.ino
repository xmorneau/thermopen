/* Thermometre IR
   ...
   -prévoir de l'Espace pour une température dépassant 4 caractères
*/
#include <Wire.h>
...
void loop() {
  if ((analogRead(A1) < 350)) { //Vo*2/3 dans le cas ou R up = 10k et Rdown = 20k  , ne fonctionne pas, reste tjrs dans le sleep moade après être activé
    digitalWrite(2, LOW);
...
//setTextWrap(false)remove decalage des chiffres
